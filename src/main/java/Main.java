package list;
	...
	public class Main {
	    public static void main(String[] args) {    
	        ...
	        System.out.println("ex11: " + ex11(head, head2, head2));
	    }
	    ...
	    public static Node<Integer> ex11(Node<Integer> head,Node<Integer> head2, Node<Integer> p2) {
